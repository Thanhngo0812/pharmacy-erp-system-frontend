...
import { FaBars, FaUser, FaSignOutAlt, FaKey, FaCalendarAlt, FaMoneyCheckAlt } from "react-icons/fa";
...
export default function AdminHeader({ toggleSidebar }) {
  ...
  const avatarUrl = user?.imgUrl || "https://res.cloudinary.com/dfcb3zzw9/image/upload/v1771060297/84760454-9909-44cf-ac6a-78c964a34ab4.png"; // Ảnh đại diện mặc định nếu user chưa có avatars
        ...
        {isOpen && (
          <>
            ...
            <div className="dropdown-menu">
              ...
              <div className="menu-item" onClick={() => { setIsOpen(false); navigate("/admin/my-salary"); }}>
                <FaMoneyCheckAlt className="menu-icon" /> Tra cứu lương
              </div>
              <div className="menu-item" onClick={() => { setIsOpen(false); navigate("/admin/my-leave-requests"); }}>
